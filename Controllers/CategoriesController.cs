...
namespace magazine.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Imgpath,ImageFile")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Name,Imgpath")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
